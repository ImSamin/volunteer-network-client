                    ...
                    <div className="register-form-child ">
                        ...
                        <form onSubmit={handleSubmit(onSubmit)}>
                            <div className="register-input ">
                                <input className="form-control" type="text" placeholder="Full Name" name="name" value={displayName} ref={register} required></input>
                            </div>
                            <div className="register-input">
                                <input className="form-control" type="text" placeholder="username or Email" name="email" value={email} ref={register} required></input>
                            </div>
                            <div className="register-input">
                            ...
                            <div className="register-input">
                                <input className="form-control" type="text" placeholder="Task Name" name="TaskName" value={taskName} ref={register} required></input>
                            </div>
                            <div className="register-input">
